...
class UpcomingInvoice(BaseInvoice):
    ...
    def invoiceitems(self):
        ...
        """
        warnings.warn(
            "This method is misleading and will be removed in dj-stripe version 2.8. Please use UpcomingInvoice.lineitems instead",
            DeprecationWarning,
        )
...
# todo audit the code as it is assumed this model can be InvoiceItem as well as LineItem
class InvoiceItem(StripeModel):
    ...
    # todo incorrect needs to be removed
    @classmethod
    def is_valid_object(cls, data):
...
class LineItem(StripeModel):
    ...
    def api_list(cls, api_key=djstripe_settings.STRIPE_SECRET_KEY, **kwargs):
        ...
        invoice = Invoice.stripe_class.retrieve(api_key=api_key, **kwargs)
